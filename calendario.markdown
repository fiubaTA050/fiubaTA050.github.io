...
<table class="table calendario">
  ...
  <tbody>
    ...
    <tr>
      <td>23 sep<span class="cal-modalidad cal-modalidad-presencial">Presencial</span></td>
    ...
    <tr class="cal-feriado cal-entrega">
      <td>25 sep</td>
      <td class="calendar-activity"><span class="lecture-title">PARO DOCENTE</span>
        <dl class="cal-activity-dl">
          <dt><i class="fa fa-bullhorn"></i> Trabajo práctico:</dt>
